## GreenMoney payment module for Magento 1.x.
...
## Uninstall/Disable
   ...
   * From the command line edit the files: 
      * `<magento_root>/app/etc/modules/Liftmode_GreenMoney.xml`
...
## Configure Magento
* The plugin is configured under **System**->**Configuration**->**Payment Methods**->**GreenMoney**.
